...
#GA
s1 = "20190303-013342-RHC-a0-.npy"

test_acc = np.load("npData/" + s1)
vals = range(len(test_acc))

s1 = "20190303-014222-SA-a0-.npy"

test_acc2 = np.load("npData/" + s1)[0:5000]
vals2 = range(len(test_acc2))


s1 = "20190303-013616-GA-a0-.npy"

test_acc3 = np.load("npData/" + s1)
...
# test_acc4 = np.load("npData/" + s1)[0:5000]
...
plt.plot(vals2, test_acc2, color=my_yellow, label='Simulated Annealing')
...
plt.ylabel("Fitness")
# plt.ticklabel_format(style='sci', axis='x', scilimits=(0,0))
plt.plot(vals3, test_acc3, color=my_blue, label='Genetic Algorithm')
...
plt.savefig("../tex/figures/RHC-SA-GA-MIMIC-P0.pdf")
plt.show()
